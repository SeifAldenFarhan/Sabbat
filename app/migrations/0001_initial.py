# Generated by Django 3.2.3 on 2022-05-31 20:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('village', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PanoramicPhotoVillage', to='app.village')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('village', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='MiscellaneousPhotoVillage', to='app.village')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='MiscellaneousPhotoCity', to='app.city')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('village', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='InstitutionPhotoVillage', to='app.village')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='InstitutionPhotoCity', to='app.city')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('village', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='EventsPhotoVillage', to='app.village')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='EventsPhotoCity', to='app.city')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('village', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='CharactersPhotoVillage', to='app.village')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='CharactersPhotoCity', to='app.city')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('village', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AerialPhotoVillage', to='app.village')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AerialPhotoCity', to='app.city')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('village', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ActionsPhotoVillage', to='app.village')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(max_length=255)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ActionsPhotoCity', to='app.city')),
            ],
        ),
    ]
